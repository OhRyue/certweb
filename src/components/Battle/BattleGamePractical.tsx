...
import { Swords, Clock, Zap, X, Sparkles, Flame, Target } from "lucide-react";
...
export function BattleGamePractical({ questions, opponentName, onComplete, onExit }: BattleGamePracticalProps) {
  ...
  const handleAnswer = () => {
    ...
    setTimeout(() => {
      if (currentQuestion < totalQuestions - 1) {
        ...
        // Battle complete
        const finalMyScore = answeredCorrectly ? myScore + 10 + Math.floor(timeLeft / 3) + Math.min(combo * 2, 20) : myScore;
