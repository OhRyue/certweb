...
import { BarChart3, TrendingUp, TrendingDown, Clock, Target, Sparkles } from "lucide-react";
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="lg:col-span-2">
            <Card className="p-6 border-2 border-purple-200">
              <h2 className="text-purple-900 mb-6">태그별 능력지수</h2>
              ...
              <div className="mt-6 p-4 bg-gradient-to-r from-red-50 to-pink-50 rounded-lg border border-red-200">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <h3 className="text-red-900 mb-2">약점 분석</h3>
